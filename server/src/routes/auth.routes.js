...
router.post('/register', speedLimiter, AuthController.register.bind(AuthController));
router.post('/login', loginRateLimit, AuthController.login.bind(AuthController));
router.post('/refresh-token', AuthController.refreshToken.bind(AuthController));
router.get('/verify-email', AuthController.verifyEmailAddress.bind(AuthController));
router.post('/resend-verification', emailVerificationRateLimit, AuthController.resendEmailVerification.bind(AuthController));
router.post('/forgot-password', passwordResetRateLimit, AuthController.requestPasswordReset.bind(AuthController));
